    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                                                                                    data-i18n="nav.templates.main">{{trans('dashboard.Setting')}}</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{trans('dashboard.Delivery means')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('shipping.edit','free')}}">{{trans('dashboard.free shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping.edit','inner')}}">{{trans('dashboard.inner shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('shipping.edit','outer')}}"
                                   data-i18n="nav.templates.vert.compact_menu">{{trans('dashboard.outer shipping')}}</a>
                            </li>
